...
$listaCursos = $cursoDao->findAll();

$turmaDao = new TurmaDaoMySql($pdo);
$listaTurmas = $turmaDao->findAll();
  ...
  <div class="layout-page">
    <div class="content-wrapper">
      <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="fw-bold py-3 mb-4 azul-marinho">Gerenciamento de Relatorios de Atestados</h4>
...
<div class="mb-3">
    ...
    <div style="display:flex;justify-content:center;">
        <img src="<?=$baseUrl?>/src/reports/img/atestado.jpg" alt="atestado" style="margin:1em;width:250px;height:300px;">
    </div>
    
        <label for="exampleFormControlSelect1" class="form-label"><b>Curso</b></label>
            <select class="form-select" id="id_curso" name="idcurso" aria-label="Selecione o curso" required >
    ...
    <div class="mb-3">
        <label for="exampleFormControlSelect1" class="form-label"><b>Turma</b></label>
            <select class="form-select" id="id_turma" name="idturma" aria-label="Selecione a turma" required >
    ...
    <div class="row">
    <div class="col mb-3">
      <label for="cadastro" class="form-label"><b>Data do cadastro</b></label>
      <input type="date" name="data_cadastrada" class="form-control" required /> 
    </div>
   
    <div class="col mb-0">
      <label for="cadastro_limit" class="form-label"><b>Data do cadastro</b></label>
      <input type="date" name="data_cadastrada_limite" class="form-control" required />
        </div>
  </div>            

<div style="display:flex;justify-content:center;padding-top:2em;" class="modal-footer">
