       ...
       <div class="row">
         <div class="col-md-12">
          <ul class="nav nav-pills flex-column flex-md-row mb-3">
              <li class="nav-item">
                 <a class="nav-link " href="consulta_aluno.php"><i class="bx bx-user me-1"></i> Aluno</a>
                </li>
             <li class="nav-item">
               <a class="nav-link active" href="consulta_anamnese.php">   <i class="menu-icon tf-icons bx bx-capsule red"></i> Anamnese</a>
                 </li>
             <li class="nav-item">
...
<div class="card">
   <h5 class="card-header">Ficha de Saúde - Anamnese</h5>
