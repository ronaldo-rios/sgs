...
<li class="menu-item">
 ...
 <!-- Inicio Menu Prontuario -->
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text azul-marinho">Prontuário</span>
            </li>
            <li class="menu-item">
 ...
 <!-- Fim Menu Prontuario -->
  ...
  <!-- Inicio Menu Cadastros -->
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text azul-marinho">Cadastros</span>
            </li>
 ...
 <!-- Fim Menu Cadastros -->
   ...
   <!-- Inicio Menu Relatórios -->
            <li class="menu-header small text-uppercase ">
              <span class="menu-header-text azul-marinho">Relatórios</span>
                </li>
...
<div class="row">
  <div class="col-md-12">
   <ul class="nav nav-pills flex-column flex-md-row mb-3">
      ...
      <li class="nav-item">
        <a class="nav-link" href="consulta_soap.php">  <i class="menu-icon tf-icons bx bx-plus-medical red"></i> SOAP</a>
          </li>
            </ul>
    ...
    <h5 class="card-header">Dados do Aluno</h5>
      <div class="card-body">
         <div class="d-flex align-items-start align-items-sm-center gap-4">
            <img scr="assets/img/avatars/1.png" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar"/>

<div class="button-wrapper">
   <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
    <span class="d-none d-sm-block">Atualizar Cadastro</span>
...
<div class="row">
 ...
 <div class="mb-3 col-md-6">
   <label class="form-label" for="country">Curso</label>
     <select id="country" class="select2 form-select">
      <option value="">Selecione</option>
      <option value="Australia">Bacharelado em SI</option>
       <option value="United States">Tecnico Informática</option>
    </select>
      </div>
<div class="mb-3 col-md-6">
   <label for="language" class="form-label">Turma</label>
   <select id="language" class="select2 form-select">
     <option value="">Selecione</option>
     <option value="en">21</option>
     <option value="en">2021</option>
       </select>
        </div>
<div class="mb-3 col-md-6">
...
<div class="mb-3 col-md-6">
  <label for="timeZones" class="form-label">ESF</label>
     <select id="timeZones" class="select2 form-select">
        <option value="">Selecione</option>
        <option value="-12">ESF 11 (Vila Jaguari)</option>
    </select>
         </div>
<div class="mb-3 col-md-6">
  <label for="currency" class="form-label">Plano de Saúde</label>
