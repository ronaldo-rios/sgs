...
$usuarioInfo = $usuarioDao->checkToken();
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?=$baseUrl;?>/src/actions/alterar_senha_action.php" method="POST">
              <h4 style="text-align:center;">Digite sua senha atual e sua nova senha para concluir a atualização de senha</h4>
              <div class="flash-message">
                ...
                <input type="hidden" name="id" value="<?=$usuarioInfo->getId();?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" style="background-color:#2B5AAD">Confirmar</button>
                </div>
              </form>
