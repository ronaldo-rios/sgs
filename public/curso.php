  ...
  <div class="layout-page">
    <div class="content-wrapper">
      <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="fw-bold py-3 mb-4 azul-marinho">Gerenciamento Cursos</h4>
...
<div class="box-search" style=" display: flex;justify-content:center;margin-bottom:30px">    
  <input type="search" class="form-control " id="search"  placeholder="Informe o nome do curso que deseja pesquisar" aria-label="Pesquise"  />
...
if (!empty($curso->findByName($data))) {
 
    $cursos = $curso->findByName($data);
...
<!--Incio Modal Editar-->
 <td>
<button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#editar-<?= $c->getId(); ?>" style="background-color:#cdf3fb;border:none">
  <i class="bx bx-edit-alt" ></i>
 </button>

 <div class="modal fade" id="editar-<?= $c->getId(); ?>" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">


<div class="modal-header">
  <h5 class="modal-title azul-marinho" id="exampleModalLabel1">Cadastro de Curso</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"style="background-color:#F14349;"></button>
      </div>

<div class="modal-body">
  <form id="editForm-<?= $c->getId(); ?>" action="<?=$baseUrl;?>/src/actions/editar_curso_action.php" method="POST">
...
<div class="modal-footer">
 ...
 <button type="submit" class="btn btn-primary azul" form="editForm-<?= $c->getId(); ?>" style="background-color:#2B5AAD">Editar</button>
...
<div class="row">
  <div class="col mb-3">
    ...
    <input type="text" name ="nome" class="form-control" placeholder="Nome curso" required />
      </div>
         </div>
