  ...
  <div class="layout-page">
    <div class="content-wrapper">
      <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="fw-bold py-3 mb-4 azul-marinho">Gerenciamento DE anamnese</h4>
...
<!-- Corpo Modal Visualização -->
<div class="modal-body">
  <div class="list-group list-group-flush">
<p href="javascript:void(0);" class="list-group-item list-group-item-action">
   <p>Nome</p>Danilo dos Santos</p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Idade</p> 18 </p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Curso</p> Tec Info  </p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Turma</p>10</p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
 <p>ESF</p> 11- Vila Jaguari</p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Plano de Saude</p>Unimed</p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Cartão SUS</p>089897</p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Medicamento Controlado</p>Não</p>

<p href="javascript:void(0);" class="list-group-item list-group-item-action">
  <p>Alergia a Medicamento </p>Não</p>

           </div>
<!-- Inicio Tabela Doenças -->
...
<!-- Inicio Modal Editar -->
 <td>
  <div class="col-lg-4 col-md-6">
    <div class="mt-3">
     <button type="button"  class="btn btn-primary" data-bs-toggle="modal"data-bs-target="#fullscreenModal" style="background-color:#cdf3fb;border:none">
...
<div class="modal-header">
  <h5 class="modal-title" id="modalFullTitle">Anamnese</h5>
...
<!-- Cabeçalho Modal -->
     <div class="modal-header">
      <h5 class="modal-title azul-marinho" id="exampleModalLabel1"> Cadastro Anamnese</h5>
<!-- Botão Fechar -->
...
<!-- Inicio Modal Cadastrar -->
 ...
 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cadastrar" style="background-color:#017EC3">
  Cadastrar
     </button>
