  ...
  <div class="layout-page">
    <div class="content-wrapper">
      <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="fw-bold py-3 mb-4 azul-marinho">Gerenciamento de Relatorios de Vacinas</h4>
...
<div class="mb-3">
    ...
    <div style="display:flex;justify-content:center;">
        <img src="<?=$baseUrl?>/src/reports/img/vacina.jpg" alt="vacina" style="margin:1em;width:250px;height:300px;">
    </div>
