...
//Buscando o paciente fornecedido pelo id
$pacientes = $paciente->findById($_GET['id']);
$pacienteNome = $pacientes->getNome();

$prontuario = new ProntuarioDaoMySql($pdo);
//Buscando o prontuario com o nome do paciente
$prontuarios = $prontuario->findByName($pacienteNome);

$soap = new SoapDaoMySql($pdo);
//Buscando o soap com o nome do paciente
$soaps = $soap->findPaciente($_GET['id']);

$prontuarioTeste = $prontuario->findAll();
...
<!-- Inicio do Card -->
<div class="card mb-4">
<!-- Mostrando dados do paciente com o array pacientes que contém os dados do paciente correpondente ao ID informado -->
...
<!-- Apresentando os dados do prontuario do aluno correpondente ao nome informado -->

<input type="hidden" name="id" value="<?= $p->getId(); ?>" />
<input type="hidden" name="matricula_paciente" value="<?= $pacientes->getMatricula(); ?>" />
<input type="hidden" name="id_paciente" value="<?= $pacientes->getId(); ?>" />
...
<div class="mb-3 col-md-6">
 ...
 <div class="row">
   <div class="mb-3 col-md-6">
      <label for="firstName" class="form-label">Nome Alergia a Medicamento</label>
...
<div class="mb-3 col-md-6">
   <label for="lastName" class="form-label">Nome Medicação Controlada</label>
...
<div class="row">
<div class="mb-3">
    <label for="exampleFormControlSelect1" class="form-label">Alergia Medicamento</label>
    <select class="form-select" name="alergia_medicamento" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getAlergiaMedicamento() === 'S') echo 'selected'; ?>>Sim</option>
        <option value="N" <?php if ($p->getAlergiaMedicamento() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="row">
<div class="mb-3">
    <label for="exampleFormControlSelect1" class="form-label"> Medicamento Controlado</label>
    <select class="form-select" name="medicamento_controlado" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getMedicamentoControlado() === 'S') echo 'selected'; ?>>Sim</option>
        <option value="N" <?php if ($p->getMedicamentoControlado() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="diabetes" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getDiabetes() === 'S') echo 'selected'; ?>>Sim</option>
        <option value="N" <?php if ($p->getDiabetes() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="pressao_alta" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getPressaoAlta() === 'S') echo 'selected'; ?>>Sim</option>
        <option value="N" <?php if ($p->getPressaoAlta() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="pressao_baixa" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getPressaoBaixa() === 'S') echo 'selected'; ?>>Sim</option>
          <option value="N" <?php if ($p->getPressaoBaixa() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="asma" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getAsma() === 'S') echo 'selected'; ?>>Sim</option>
          <option value="N" <?php if ($p->getAsma() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="bronquite" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getBronquite() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getBronquite() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="anemia" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getAnemia() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getAnemia() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="ansiedade" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getAnsiedade() === 'S') echo 'selected'; ?>>Sim</option>
          <option value="N" <?php if ($p->getAnsiedade() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="depressao" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getDepressao() === 'S') echo 'selected'; ?>>Sim</option>
        <option value="N" <?php if ($p->getDepressao() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="insonia" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getInsonia() === 'S') echo 'selected'; ?>>Sim</option>
        <option value="N" <?php if ($p->getInsonia() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="hemofilia" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getHemofilia() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getHemofilia() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="tuberculose" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getTuberculose() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getTuberculose() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="eplepsia" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getEplepsia() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getEplepsia() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="mb-3">
    ...
    <select class="form-select" name="desmaios" aria-label="Selecione a opção">
         <option > Selecione </option>
         <option value="S" <?php if ($p->getDesmaios() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getDesmaios() === 'N') echo 'selected'; ?>>Não</option>
    </select>
      </div>
        </div>
...
<div class="row">
    <div class="mb-3">
        ...
        <select class="form-select" name="fumante" aria-label="Selecione a opção">
            <option>Selecione</option>
            <option value="S" <?php if ($p->getFumante() === 'S') echo 'selected'; ?>>Sim</option>
            <option value="N" <?php if ($p->getFumante() === 'N') echo 'selected'; ?>>Não</option>
        </select>
    </div>
</div>
...
<div class="col mb-0">
  <label for="emailBasic" class="form-label">Outro</label>
    <input type= "text" name="outro" class="form-control" placeholder="Outra Informação que achar relevante"  value="<?= $p->getOutro(); ?>"/>
      </div>
        </div>
        <div style="margin-top: 20px;">
        <button type="submit" class="btn btn-primary ">Atualizar Prontuário</button>
        </div>
          </form>
          <?php endforeach; ?>   
...
<!--Incio Modal Editar-->
<td>
<button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#editar-<?= $s->getId(); ?>" style="background-color:#cdf3fb;border:none">
  <i class="bx bx-edit-alt" ></i>
 </button>

 <div class="modal fade" id="editar-<?= $s->getId(); ?>" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
...
<div class="modal-body">
  <form id="editForm-<?= $s->getId(); ?>" action="<?=$baseUrl;?>/src/actions/editar_soap_action.php" method="POST">
  <input type="hidden" name="id_prontuario" value="<?= $p->getId(); ?>" />
  <input type="hidden" name="id_soap" value="<?= $s->getId(); ?>" />
  <div class="row">
  <div class="col-md-12 col-12 mb-md-0 mb-4">
     <div class="card">
          <div class="card-body">
          ...
          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Subjetivo</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="subjetivo"><?= $s->getSubjetivo(); ?></textarea>
                  </div>

         <div class=" mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Objetivo</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="objetivo"><?= $s->getObjetivo(); ?></textarea>
                </div>

        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Avaliação</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="avaliacao"><?= $s->getAvaliacao(); ?></textarea>
                </div>
                      
        <div class="mb-3">
          <label for="exampleFormControlTextarea1" class="form-label">Plano</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="plano"><?= $s->getPlano(); ?></textarea>
               </div>
                  </div>
                    </div>
                      </div>
...
<div class="modal-footer">
 ...
 <button type="submit" class="btn btn-primary azul" form="editForm-<?= $s->getId(); ?>" style="background-color:#2B5AAD">Editar</button>
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#excluir-<?= $s->getId(); ?>" style="background-color:#cdf3fb;border:none">
  <i class="bx bx-trash-alt"  ></i>
</button>

<div class="modal fade" id="excluir-<?= $s->getId(); ?>" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       <h5 class="modal-title azul-marinho" id="exampleModalLabel1">Cadastro SOAP</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="background-color:#F14349;" ></button>
          </div>
...
<div class="modal-footer">
<a href="<?=$baseUrl;?>/src/actions/deletar_curso_action.php?id=<?=$s->getId();?>">
...
<div class="modal-body">
<form action="<?=$baseUrl;?>/src/actions/inserir_soap_action.php" id="cad" method="POST">
  ...
  <div class="col-md-12 col-12 mb-md-0 mb-4">
     <div class="card">
          ...
          <div class="mb-3 row">
            <label for="html5-datetime-local-input" class="col-md-2 col-form-label">Data</label>
                <div class="col-md-10">
                    <input class="form-control" type="date" name="data"  id="html5-datetime-local-input" />
                       </div>
                          </div>

          <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Subjetivo</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="subjetivo"></textarea>
                  </div>
        ...
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Avaliação</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="avaliacao"></textarea>
                </div>
                      
        <div class="mb-3">
          <label for="exampleFormControlTextarea1" class="form-label">Plano</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="plano"></textarea>
               </div>
                  </div>
                    </div>
                      </div>
