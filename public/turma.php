...
if (!empty($turma->findByName($data))) {
    $turmas = $turma->findByName($data);
...
<!--Incio Modal Editar-->
 <td>
<button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#editar-<?= $t->getId(); ?>" style="background-color:#cdf3fb;border:none">
  <i class="bx bx-edit-alt" ></i>
 </button>

 <div class="modal fade" id="editar-<?= $t->getId(); ?>" tabindex="-1" aria-hidden="true">
...
<div class="modal-body">
  <form id="editForm-<?= $t->getId(); ?>" action="<?=$baseUrl;?>/src/actions/editar_turma_action.php" method="POST">

  <input type="hidden" name="id" value="<?= $t->getId(); ?>" />
  <div class="row">
    <div class="col mb-3">
      <label for="name" class="form-label">Nome</label>
      <input type="text" name="nome" class="form-control" value="<?= $t->getNome(); ?>" /> 
    </div>
  </div>
</div>
...
<div class="modal-footer">
 ...
 <button type="submit" class="btn btn-primary azul" form="editForm-<?= $t->getId(); ?>" style="background-color:#2B5AAD">Editar</button>
...
<div class="row">
  <div class="col mb-3">
    ...
    <input type="text" name ="nome" class="form-control" placeholder="Nome turma" required />
      </div>
         </div>
