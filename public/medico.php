  ...
  <div class="layout-page">
    <div class="content-wrapper">
      <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="fw-bold py-3 mb-4 azul-marinho">Gerenciamento Médico</h4>
...
<div class="row">
  ...
  <div class="col mb-3">
    ...
    <div class="col mb-3">
      ...
      <input type="text" name="crm" class="form-control" value="<?= $u->getCrm(); ?>" /> 
    </div>
  </div>
...
<input type="hidden" name="permissao" value="medico" />
...
<div class="col mb-0">
    <label for="dobBasic" class="form-label">SIAPE</label>
     <input type="text" name="siap" class="form-control" placeholder="Informe o SIAPE" />
       </div>
  <div class="col mb-0">
    <label for="dobBasic" class="form-label">CRM</label>
     <input type="text" name="crm" class="form-control" placeholder="Informe o CRM" />
       </div>
         </div>
...
<div class ="row g-2">
  <div class="col mb-0">
    ...
    <input type="text" name="email" class="form-control" placeholder="E-mail do médico" required />
      </div>
