  ...
  <div class="layout-page">
    <div class="content-wrapper">
      <div class="container-xxl flex-grow-1 container-p-y">
       <h4 class="fw-bold py-3 mb-4 azul-marinho">Gerenciamento DE MédicoS</h4>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
           <h5 class="modal-title" id="modalFullTitle">Cadastro Médico</h5>
...
<div class="modal fade" id="editar" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
       <div class="modal-header">
        <h5 class="modal-title azul-marinho" id="exampleModalLabel1">Cadastro de Médico</h5>
...
<div class="row g-2">
        <div class="col mb-0">
          <label for="emailBasic" class="form-label">SIAPE</label>
            <input type="text" id="SIAPE" class="form-control" value=""/>
             </div>
      <div class="col mb-0">
        <label for="dobBasic" class="form-label">CRM</label>
         <input type="text" id="CRM" class="form-control" value="" />
          </div>
            </div>
          </div>
...
<div class="modal fade" id="excluir" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       <h5 class="modal-title azul-marinho" id="exampleModalLabel1">Cadastro Médico</h5>
        <button type="button" class="btn-close botao-red" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
...
<div class="modal-body">
  <div class="row">
    <div class="col mb-3">
      <label for="nameBasic" class="form-label">Nome</label>
        <input type="text" id="nome" class="form-control" placeholder="Informe o nome completo do médico" />
          </div>
            </div>
<div class="row g-2">
  <div class="col mb-0">
    <label for="emailBasic" class="form-label">Email</label>
       <input type="text" id="email" class="form-control" placeholder="Informe o e-mail do médico" />
        </div>
 <div class="col mb-0">
    <label for="dobBasic" class="form-label">CPF</label>
     <input type="text" id="CPF" class="form-control" placeholder="Informe o CPF do médico" />
       </div>
           </div>
<div class="row g-2">
     <div class="col mb-0">
       <label for="emailBasic" class="form-label">SIAPE</label>
          <input type="text" id="SIAPE" class="form-control" placeholder="Informe o SIAPE do médico" />
           </div>
    <div class="col mb-0">
       <label for="dobBasic" class="form-label">CRM</label>
        <input type="text" id="CRM" class="form-control" placeholder="Informe o CRM do médico" />
          </div>
            </div>
              </div>
...
<div class="modal-footer">
  <button type="button" class="btn btn-outline-secondary botao-red" data-bs-dismiss="modal" style="background-color:#F14349;color: white;" >Cancelar </button>
  <button type="button" class="btn btn-primary azul"  style="background-color:#2B5AAD"> Salvar</button>
    </div>
      </div>
        </div>
          </div>
