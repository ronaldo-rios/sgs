...
$asma = filter_input(INPUT_POST, 'bronquite', FILTER_SANITIZE_SPECIAL_CHARS);
$bronquite = filter_input(INPUT_POST, 'asma', FILTER_SANITIZE_SPECIAL_CHARS);
...
$tubercoluse = filter_input(INPUT_POST, 'tubercoluse', FILTER_SANITIZE_SPECIAL_CHARS);
$hemofilia = filter_input(INPUT_POST, 'hemofilia', FILTER_SANITIZE_SPECIAL_CHARS);
...
$id_usuario = filter_input(INPUT_POST, 'id_usuario', FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    $prontuarioDao = new ProntuarioDaoMySql($pdo);
        ...
        $prontuario->setTubercoluse($tubercoluse);
