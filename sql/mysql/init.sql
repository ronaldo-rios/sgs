...
VALUES
    ...
    ('UpdatePermission', 'index', 'update-permission', 'index', 'Atualizar Permissões de Nível de Acesso', 0, 0, NULL, 1, 4, 1, NOW()),
    ...
    ('UpdateProfile', 'index', 'update-profile', 'index', 'Atualizar Perfil de Usuário Logado', 0, 0, NULL, 1, 4, 1, NOW()),
    ...
    ('UpdateUser', 'index', 'update-user', 'index', 'Editar Usuário', 0, 0, NULL, 1, 4, 1, NOW()),
    ...
    ('UpdateAccessLevel', 'index', 'update-access-level', 'index', 'Editar Nível de Acesso', 0, 0, NULL, 1, 4, 1, NOW()),
    ('DeleteAccessLevel', 'index', 'delete-access-level', 'index', 'Deletar Nível de Acesso', 0, 0, NULL, 1, 5, 1, NOW()),
    ('ConfigEmails', 'index', 'config-emails', 'index', 'Configurações de Email', 0, 1, 'fa-solid fa-envelope', 1, 1, 1, NOW()),
    ('ViewConfigEmail', 'index', 'view-config-email', 'index', 'Visualizar Configuração de Email', 0, 0, NULL, 1, 2, 1, NOW()),
    ('AddConfigEmail', 'index', 'add-config-email', 'index', 'Adicionar Nova Configuração de Email', 0, 0, NULL, 1, 3, 1, NOW()),
    ('UpdateConfigEmail', 'index', 'update-config-email', 'index', 'Editar Configuração de Email', 0, 0, NULL, 1, 4, 1, NOW()),
    ('DeleteConfigEmail', 'index', 'delete-config-email', 'index', 'Remover Configuração de Email', 0, 0, NULL, 1, 5, 1, NOW()),
    ...
    ('UpdatePage', 'index', 'update-page', 'index', 'Editar Página', 0, 0, NULL, 1, 4, 1, NOW()),
    ...
    ('UpdatePageType', 'index', 'update-page-type', 'index', 'Editar Tipo de Página', 0, 0, NULL, 1, 4, 1, NOW()),
    ...
    ('UpdatePageModule', 'index', 'update-page-module', 'index', 'Editar Módulo', 0, 0, NULL, 1, 4, 1, NOW()),
